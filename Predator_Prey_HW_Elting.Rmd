...
Now that I have a numerical integration of this model, I will use this model to represent prey and predator relationships with the following given values of the variables listed in the (#Index of Variables in Model)
```{r}
#length of run : 15000
